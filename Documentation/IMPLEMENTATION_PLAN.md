...
- **The 15 remaining coverage gaps cannot be closed from the literature on hand.** A 673-paper corpus was searched for their primary sources and contains none of them — the corpus skews 2025–2026, the gap techniques are 2022–2023 originals. Closing them means fetching those specific papers, not reading more of what is already here. See [`LITERATURE_CORPUS.md`](./LITERATURE_CORPUS.md).
