...
import {
  ...
  PLACEHOLDER_GATE_ID, RUNTIME_KEY_GATE_ID,
  PLACEHOLDER_GATE_VERSION, RUNTIME_KEY_GATE_VERSION,
} from "./placeholder-audit.js";
import {
  sourceLedgerMissing, orphanClaims,
  LEDGER_GATE_ID, ORPHAN_GATE_ID, LEDGER_GATE_VERSION, ORPHAN_GATE_VERSION,
...
import {
  ...
  DUPLICATE_GATE_ID, DELIMITER_GATE_ID,
  GUARDRAIL_GATE_VERSION, TOKEN_SPAM_GATE_VERSION, RECURSION_GATE_VERSION,
  RAG_SHIELD_GATE_VERSION, DUPLICATE_GATE_VERSION, DELIMITER_GATE_VERSION,
} from "./guardrail-gap.js";
import {
  tokenBudget, qutmCeiling, contextLimit,
  TOKEN_BUDGET_GATE_ID, QUTM_GATE_ID, CONTEXT_LIMIT_GATE_ID,
  TOKEN_BUDGET_GATE_VERSION, QUTM_GATE_VERSION, CONTEXT_LIMIT_GATE_VERSION,
} from "./budget.js";
import {
...
const GATES: readonly Gate[] = Object.freeze([
  ...
  { id: PLACEHOLDER_GATE_ID, version: PLACEHOLDER_GATE_VERSION, run: (t, o) => placeholderAudit(t, o) },
  { id: RUNTIME_KEY_GATE_ID, version: RUNTIME_KEY_GATE_VERSION, run: (t, o) => runtimeKeyUndeclared(t, o) },
  { id: LEDGER_GATE_ID, version: LEDGER_GATE_VERSION, run: (t, o) => sourceLedgerMissing(t, o) },
  { id: ORPHAN_GATE_ID, version: ORPHAN_GATE_VERSION, run: (t, o) => orphanClaims(t, o) },
  { id: GUARDRAIL_GATE_ID, version: GUARDRAIL_GATE_VERSION, run: (t, o) => guardrailGap(t, o) },
  { id: TOKEN_SPAM_GATE_ID, version: TOKEN_SPAM_GATE_VERSION, run: (t, o) => tokenSpam(t, o) },
  { id: RECURSION_GATE_ID, version: RECURSION_GATE_VERSION, run: (t, o) => recursionMachineryPresent(t, o) },
  { id: RAG_SHIELD_GATE_ID, version: RAG_SHIELD_GATE_VERSION, run: (t, o) => ragShieldGap(t, o) },
  { id: DUPLICATE_GATE_ID, version: DUPLICATE_GATE_VERSION, run: (t, o) => duplicateInstruction(t, o) },
  { id: DELIMITER_GATE_ID, version: DELIMITER_GATE_VERSION, run: (t, o) => delimiterEntropy(t, o) },
  { id: TOKEN_BUDGET_GATE_ID, version: TOKEN_BUDGET_GATE_VERSION, run: (t, o) => tokenBudget(t, o) },
  { id: QUTM_GATE_ID, version: QUTM_GATE_VERSION, run: (t, o) => qutmCeiling(t, o) },
  { id: CONTEXT_LIMIT_GATE_ID, version: CONTEXT_LIMIT_GATE_VERSION, run: (t, o) => contextLimit(t, o) },
