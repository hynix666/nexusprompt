...
| [08-known-issues-and-decisions.md](./08-known-issues-and-decisions.md) | 14 ADRs, the truth boundary, the open register, and the recurring defect patterns |
...
| `Documentation/` | 42 Markdown files: 14 ADRs, implementation plan, architecture, references, the generated manifest spec, the generated truth boundary |
