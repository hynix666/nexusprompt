...
| Tests | 1,380 passing, 0 failing, across 35 files |
...
| Artifact hash | `17e5d2b58db8b7e9…` over 77 runtime files, LF-normalised so a Windows and a Linux checkout agree |
| Truth boundary | 9 machine-checked entries stating what this repository establishes and what it does **not** |
| Commits | 128 — and note that a commit stating this number changes it, which is why it is not pinned |
| Licence | MIT |
