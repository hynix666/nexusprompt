...
- `Documentation/` — 39 Markdown files describing the *target* architecture of the platform, plus three review documents assessing it. This is still the bulk of the repository, and it still describes a system far larger than what exists.
